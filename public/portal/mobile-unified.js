(function () {
  ...
  const defaultUsageHelpGuides = [
    ...
    {
      name: "AI智能能力中心",
      match: [/ai-capabilities/i, /AI智能|AI能力|智能能力|DeepSeek/],
      lines: [
        "这个页面是全站 AI 建设蓝图，不是聊天页；用于说明哪些 AI 功能已经上线、哪些正在规划、哪些只允许给建议。",
        "已上线重点：课堂反馈AI助手、短视频系统 DeepSeek 专家报告、全站使用方法AI提问助手。",
        "优先建设重点：招生跟进建议、学生服务预警、出门测趋势解读、教研资料自动归档。",
        "安全边界：财务、排课、人事等关键数据，AI 只能生成建议、说明和复核提醒，不能直接改账、改课表、删人或改权限。",
        "后续讨论新 AI 功能时，先在这个页面看它属于主写、辅助分析、预警提醒还是只读解释。"
      ]
    },
    {
      name: "学管知识库系统",
  ...
  const usageHelpQuestionSets = {
    ...
    AI智能能力中心: ["现在已经上线了哪些AI功能？", "哪些系统不能让AI直接改数据？", "下一步优先做什么AI功能？"],
    ...
    AI智能能力中心: [
      {
        title: "页面作用",
        items: [
          "这里是全站 AI 功能规划图，帮助管理员和老师知道 AI 已经能做什么、接下来要做什么。",
          "它不直接生成业务数据，也不替代课堂反馈、短视频、招生、财务等具体系统。",
          "讨论新功能时，先判断它属于主写内容、辅助分析、预警提醒、资料归档还是只读问答。"
        ]
      },
      {
        title: "已经上线",
        items: [
          "课堂反馈AI助手：老师输入课堂情况，DeepSeek 生成家长可读反馈，老师确认后保存或归档。",
          "短视频系统：采集完成后，DeepSeek 根据视频数据生成账号诊断、复拍方向和行动清单。",
          "使用方法AI提问助手：老师不会用系统时，可以先问绿色按钮。"
        ]
      },
      {
        title: "安全边界",
        items: [
          "招生、学生服务、教研资料可以逐步让 AI 多写建议和草稿。",
          "财务、排课、人事权限等高风险操作，AI 只做解释、提醒和建议，最终必须人工确认。",
          "AI 调用失败时，关键业务不能自动造假数据；页面必须提示失败原因。"
        ]
      }
    ],
    学管知识库系统: [
