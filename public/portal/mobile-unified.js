(function () {
  ...
  const defaultUsageHelpGuides = [
    ...
    {
      name: "AI管理中心",
      match: [/ai-capabilities/i, /AI管理|AI智能|AI能力|智能能力|MiniMax/],
      lines: [
        "这个页面是管理员查看 AI 状态的地方，不是普通老师的日常入口。",
        "管理员主要在这里确认 MiniMax 是否接通、课堂反馈和短视频 AI 是否正常。",
  ...
  const usageHelpQuestionSets = {
    ...
    AI管理中心: ["MiniMax是否接通？", "哪些业务AI已经启用？", "哪些系统不能让AI直接改数据？"],
  ...
  const usageHelpGuideSections = {
    ...
    AI管理中心: [
      ...
      },
      {
        title: "已经上线",
        items: [
          "课堂反馈AI助手：老师输入课堂情况，MiniMax 生成家长可读反馈，老师确认后保存或归档。",
          "短视频系统：采集完成后，MiniMax 根据视频数据生成账号诊断、复拍方向和行动清单。",
