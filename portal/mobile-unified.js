(function () {
  ...
  const defaultUsageHelpGuides = [
    ...
    {
      name: "AI管理中心",
      match: [/ai-capabilities/i, /AI管理|AI智能|AI能力|智能能力|DeepSeek/],
      lines: [
        "这个页面是管理员查看 AI 状态的地方，不是普通老师的日常入口。",
        "管理员主要在这里确认 DeepSeek 是否接通、课堂反馈和短视频 AI 是否正常。",
        "老师日常使用 AI 时，直接进课堂反馈、短视频、招生、学生服务等具体系统。",
        "安全边界：财务、排课、人事等关键数据，AI 只能生成建议、说明和复核提醒，不能直接改账、改课表、删人或改权限。",
        "如果普通员工打开这里提示无权限，这是正常的。"
      ]
    },
    {
      name: "学管知识库系统",
  ...
  const usageHelpQuestionSets = {
    ...
    AI管理中心: ["DeepSeek是否接通？", "哪些业务AI已经启用？", "哪些系统不能让AI直接改数据？"],
