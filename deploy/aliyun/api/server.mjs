...
function aiSystemPrompt() {
  return [
    ...
    "课堂反馈的“一、上课状态”只能写本节课实际发生的状态和表现；不得写“建议家长”“建议孩子”“后续关注”“可让孩子”等建议性内容。",
...
function buildAiUserPrompt(body) {
  ...
  return [
    ...
    mode === "classFeedback" ? [
      ...
      "整体要求：内容要充实、具体、自然，单个学生整份课堂反馈（含标题和五段正文）控制在 650-750 字，约 700 字。老师原始内容很多时，优先压缩重复解释和泛化文字，不要无上限加长；也不要为了凑字数编造事实。",
      ...
      batchStudents.length > 1 ? [
        ...
        "多个学生的公共上课内容可以一致，但每个学生的上课状态和学习掌握情况要结合姓名分别写，不能复制成完全相同的反馈。",
        "每份 parentMessage 里只写该学生姓名，不要写其他学生姓名。"
      ].join("\n") : "",
      "某某的家长您好，这是春季小课第__次课程反馈：",
      "一、上课状态：",
      "只根据老师原始描述记录本节课发生的课堂状态、专注度、互动、纪律和老师当堂提醒，写 2-4 句。",
      "本栏只反映事实上课状态，不写给家长的建议、后续关注、复习方法、让孩子做什么、下次课计划或泛化的学习提醒。",
      "二、本次课上课内容：",
      "1. 从老师原始描述中提取主要上课内容",
